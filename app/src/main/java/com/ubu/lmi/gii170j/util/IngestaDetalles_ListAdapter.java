...
public class IngestaDetalles_ListAdapter extends ArrayAdapter<DetallesIngesta> {
    ...
    public IngestaDetalles_ListAdapter(@NonNull Context context, int resource, @NonNull ArrayList<DetallesIngesta> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        DetallesIngesta detalle_list_ingesta = new DetallesIngesta(tipo,nombre,cantidad,indice_glucemico);
